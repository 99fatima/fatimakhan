...
def banner():
	clear()
	print("""%s\n\x1b[93;1m
  _______      ___      .___________. __  .___  ___.      ___      
 |   ____|    /   \     |           ||  | |   \/   |     /   \     
 |  |__      /  ^  \    `---|  |----`|  | |  \  /  |    /  ^  \    
 |   __|    /  /_\  \       |  |     |  | |  |\/|  |   /  /_\  \   
 |  |      /  _____  \      |  |     |  | |  |  |  |  /  _____  \  
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>      \x1b[93;1mFATIMA BASHIR
\x1b[93;1m FACEBOOK       \x1b[92;1m=>      \x1b[93;1m100072362822003
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTECHNICAL FATIMA
\x1b[93;1m GitHub. ðŸ‘‰ðŸ‘‰ \x1b[92;1m=>    \x1b[93;1m99fatima
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Fatima
	...
	print("""%s \33[1;33m[1] Clone File  """%(h))
	print("""%s \33[1;33m[0] DAFA HOYEE"""%(h))
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	farhan = input(x+'\33[1;96mâ€¢Input Number> ')
	if farhan in ['1','01']:
		File2()
	elif farhan in ['0','00']:
		os.system("xdg-open https://youtube.com/channel/UCyaFVBnmLnjBGSJgZNeP8Fg")
		exit()
	else:
		os.system("https://youtube.com/channel/UCyaFVBnmLnjBGSJgZNeP8Fg")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [FATIMA] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [FATIMA-CP] %s|%s        '%(b,idf,pw))
